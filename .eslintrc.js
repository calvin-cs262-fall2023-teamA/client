module.exports = {
  ...
  rules: {
    ...
    'indent' : 'off',
    'prettier/prettier': 'off', // some prettier rules go against eslint rules
    ...
    'no-use-before-define': 'off' // we usually define styles at the end of the file, so disabling this to ignore styles being used before defining
  },
};
